...
use Deviate\Activities\Exceptions\UserNotInvitedToActivityException;

class UserMustBeInvited implements PreconditionInterface
{
    ...
    {
        throw new UserNotInvitedToActivityException;
    }
}
